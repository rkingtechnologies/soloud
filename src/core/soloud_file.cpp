...
DiskFile::DiskFile(FILE* fp) : mFileHandle(fp) {
}
...
result MemoryFile::openMem(const unsigned char* aData, unsigned int aDataLength,
...
int Soloud_Filehack_fopen_s(
  Soloud_Filehack** f, const char* aFilename, char* /*aMode*/) {
