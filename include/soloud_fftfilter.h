...
class FFTFilterInstance : public FilterInstance {
 ...
 public:
  ...
  void magPhase2MagFreq(float* aFFTBuffer, unsigned int aSamples,
    float aSamplerate, unsigned int aChannel);
  void magFreq2MagPhase(float* aFFTBuffer, unsigned int aSamples,
    float aSamplerate, unsigned int aChannel);
